...
import './contentregistration.style.css';
import FormRegister from '../FormRegister/FormRegister.js'
...
const ContentRegistration = ({ onRegister, user }) => {
            ...
            <Grid container>
              ...
              <Grid item xs={7}>
                  <Paper className={classes.paperLeft} >
                    <div className={classes.contentRegistrationBlog}>
                      <div>
              ...
              <Grid item xs={5}>
                  <Paper className={classes.paperRight} >
                      <FormRegister onRegister={onRegister} user={user} />
                  </Paper>
              </Grid>
